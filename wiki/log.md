...
Pages created: `wiki/sources/bim-construction/documento-parana-governanca-obras.md` — transcrição integral (sem resumo) do edital publicado pelo Governo do Estado do Paraná (SGSD); ciclo DFD→ETP→projeto BIM→orçamento→licitação→execução→medição→transparência; POC 45 critérios / 500 pontos; Estratégia BIM Paraná; UTEA; SIM-AM TCE-PR; 11 secretarias; `wiki/projects/proposta-parana-governanca-obras.md` — página de projeto para proposta AltoQi ao edital estadual do Paraná; escopo funcional, modelo comercial, POC por bloco, diferenciais e gaps estratégicos
Pages updated: `wiki/index.md` — nova source BIM e novo projeto em Projects; `wiki/overview.md` — contadores atualizados (35 sources / 88 páginas), último ingest atualizado, novo bullet BIM [³⁵], encerramento do parágrafo BIM com citação [³⁵]; `wiki/glossary.md` — novos termos: UTEA, SIM-AM TCE-PR, Eventograma, DFD, ETP, Estratégia BIM Paraná, POC em Licitação, RBAC; `wiki/concepts/bim-construction/bim-regulatorio-brasil.md` — nova seção Estratégia BIM Paraná estadual (Decreto 10.086/2022, Decreto 10.585/2025, UTEAs, SIM-AM TCE-PR, R$55M), nova seção SIM-AM TCE-PR, nova seção Fluxo DFD→ETP→TR; `mkdocs.yml` — nova source e novo project no nav; `raw/ingested.md` — registro do arquivo `documento_parana.md`
Key additions: Primeiro edital governamental estadual no wiki — abre a dimensão de cliente governo estadual para a AltoQi. O Paraná usa a Lei 14.133/2021 para exigir a cadeia documental completa DFD→ETP→TR como objeto de produto integrado. A POC com 45 critérios funciona como mapa funcional completo da plataforma candidata. Conexão inédita: os requisitos do edital Paraná cobrem exatamente o gap que o documento MPD identifica (procurement→medição→pagamento), confirmando que o ciclo contratual completo é uma exigência de mercado tanto privado quanto público.

## [2026-05-05] query | verificação de consistência de links e backlinks pós-ingest MPD
Pages updated: `wiki/analyses/axis-planning-proximos-passos.md` — correção de links quebrados (`products/`→`projects/`, aliases inválidos em wikilinks, referência source path); `wiki/concepts/bim-construction/bim-regulatorio-brasil.md` — correção de links para projetos e source FINEP; `wiki/concepts/bim-construction/openbim-standards.md` — correção de links para projetos e source FINEP; `wiki/concepts/bim-construction/planejamento-preditivo-obras.md` — correção de links para projetos e source FINEP; `wiki/concepts/bim-construction/construcao-40.md` — correção de links para projeto Axis; `wiki/concepts/ai-engineering/ai-session-memory.md` — referência atualizada para análise existente; `wiki/sources/ai-engineering/daniel-rusnok-mem0-mcp-semantic-memory.md` — referência atualizada para análise existente; `wiki/sources/bim-construction/gt-antac-visus-planning-objeto-aprendizagem.md` — link para projeto corrigido; `wiki/projects/altoqi-axis.md` — source path FINEP corrigido; `wiki/index.md` — source path FINEP corrigido e backlink explícito para `[[log]]`; `wiki/glossary.md` — source path FINEP corrigido
...
Pages created: `wiki/sources/bim-construction/visus-evolucao-mpd-analise-produto.md` — transcrição integral (sem resumo) da análise AS IS/TO BE com metodologia de pacotes, fluxos de contratação/execução, gap analysis por módulo e roadmap P1–P6; `wiki/projects/mpd-visus-evolucao-plataforma.md` — página de projeto para portfólio com objetivo, recorte de roadmap, dependências estruturais e links para conteúdo integral
Pages updated: `wiki/index.md` — nova source BIM e novo projeto em Projects; `wiki/overview.md` — contadores atualizados (34 sources / 86 páginas), último ingest atualizado e novos pontos de síntese com citação [34]; `wiki/glossary.md` — novos termos de procurement/gestão contratual (Pacote de Entrega, Gate 4, Carta Convite, Mapa de Cotações, BM, Glosa, DataBook, EAP mínima obrigatória); `wiki/projects/altoqi-visus-planning.md` — correção de link interno para Axis + backlinks para projeto/source MPD; `wiki/projects/altoqi-axis.md` — backlinks para caso MPD; `wiki/projects/finep-mais-inovacao-brasil-2026.md` — conexão explícita entre framing FINEP e caso aplicado MPD; `wiki/projects/altoqi-company.md` — inclusão do projeto MPD no índice institucional; `wiki/projects/altoqi-check.md` — backlinks para projeto/source MPD; `mkdocs.yml` — navegação com nova source e novo project; `raw/ingested.md` — registro do arquivo `visus-evolucao-mpd-analise-produto.md`
Key additions: Primeiro caso enterprise no wiki com especificação operacional completa do gap pós-BIM em linguagem de produto: o gargalo competitivo imediato está no ciclo procurement→contrato→medição→pagamento, não na modelagem em si. O documento torna explícita a necessidade arquitetural de EAP mínima obrigatória no Cost para habilitar visão macro de pacotes na Control Tower e rastreabilidade fim a fim entre modelo BIM, contrato e pagamento.
...
Pages updated: `wiki/projects/altoqi-visus-planning.md` — nova seção "AltoQi Axis — Camada de IA do Ecossistema (2026)" com 6 capacidades, pilares de design, conexão com módulos Visus, tabela de relevância cross-domain wiki; `wiki/concepts/bim-construction/construcao-40.md` — nova seção "Materialização no Mercado: AltoQi Axis (2026)"; `wiki/glossary.md` — atualizado AltoQi Visus Planning + novo termo AltoQi Axis; `wiki/index.md` — product summary expandido com Axis; `wiki/overview.md` — novo bullet "AltoQi Axis (2026)" na seção BIM; key insight BIM+AI expandido com menção ao Axis
...
Pages created: `wiki/sources/bim-construction/gt-antac-visus-planning-objeto-aprendizagem.md` — tutorial completo 4 módulos: modelo federado IFC, EAP, cronograma, setorização, simulação 4D, rastreamento planejado vs. executado, relatórios; `wiki/projects/altoqi-visus-planning.md` — nova página de produto (primeiro uso do diretório `wiki/projects/`)
